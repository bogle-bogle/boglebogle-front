...
import { HeendycarHeader, HeendycarImgBox, HeendycarHeaderText, HeendycarTitle, HeendycarSubTitle, HeendycarDescription } from './index.style';
  ...
  return (
    <div>
        ...
        <HeendycarDescription>
            ...
            <br/>
            또한 고객님들의 편의를 위해, 더현대서울 및 현대프리미엄아울렛에서는 반려동물 트롤리인 ‘흰디카’ 대여 서비스를 제공합니다.
            <br/>
