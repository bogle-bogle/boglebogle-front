  ...
  return (
    ...
    {windowWidth<=768 ? (
      <MobileMedia>
        ...
        <MGuide>맞춤 상품 추천을 위해 반드시 프로필 정보를 입력하셔야 합니다.</MGuide>
        ...
        <AgreementSection2>
          <AgreementLabel>개인정보 마케팅 활용동의(혜택알림) (선택)</AgreementLabel>
            <AgreementRadioGroup>       
              <AgreementRadio
                name="agreement2"
                value="yes"
        ...
        <MButton>
          <BlackButton type="submit" disabled={!agreed1} onClick={handleAgreementButtonClick}>가입하기</BlackButton>
        </MButton>
        {showAgreementPopup && (
      ...
      <StyledClubContainer>
        ...
        <Guide>맞춤 상품 추천을 위해 반드시 프로필 정보를 입력하셔야 합니다.</Guide>
