...
import { BenefitContainer, BenefitContent, BenefitRow, BenefitRowDl, BenefitTitle, ButtonContainer, ClubHeendyContainer, ClubHeendyDiscount, ClubHeendyLogo, DetailButton, InfoIconContainer, ProductDetailImg, ProductInfoContainer, ProductName, ProductPriceContainer, ProductSummary } from './detail.style'
          ...
          <BenefitContainer>
            <BenefitRow>
              <BenefitRowDl>
                ...
                <BenefitContent>삼성7% 즉시할인(5만원 이상 결제시)<br/>현대백화점카드5%</BenefitContent>
              </BenefitRowDl>
            </BenefitRow>
            <BenefitRow>
              <BenefitRowDl>
            ...
            <BenefitRow>
              <BenefitRowDl>
                ...
                <BenefitContent>H.Point 90P 적립<br/>KB제휴카드 결제시 최대 1.5% 추가적립</BenefitContent>
              </BenefitRowDl>
            </BenefitRow>
            <BenefitRow>
              <BenefitRowDl>
