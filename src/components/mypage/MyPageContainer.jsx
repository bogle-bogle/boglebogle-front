...
import { MyInfoBox, MyInfoBoxCnt, MyInfoBoxTitle, MyInfoContainer, MyInfoElement, MyInfoTitle, MypageAdv, MypageAdvBtn, MypageAdvImg, MypageBoldBorder, MypageBorder, MypageContent, MypageGrid, MypageMiniTitle, MypageSidebar, MypageSubtitle, MypageTitle } from './mypage.style';
...
function MyPageContainer() {
  ...
  <MypageGrid>
    ...
    <MypageSidebar>
      ...
      <MypageMiniTitle onClick={() => setSelectedMenu('mypet')}>나의 반려동물 목록</MypageMiniTitle>
      <MypageMiniTitle>나의 반려동물 맞춤 추천</MypageMiniTitle>
      <MypageBorder />

      <MypageSubtitle>나의 쇼핑내역</MypageSubtitle>
      <MypageMiniTitle onClick={() => setSelectedMenu('myorder')}>주문/배송 조회</MypageMiniTitle>
      <MypageMiniTitle onClick={() => setSelectedMenu('mysubscription')}>구독 관리</MypageMiniTitle>
      <MypageBorder />

      <MypageSubtitle>나의 흰디카 예약</MypageSubtitle>
      <MypageMiniTitle>자주 찾는 지점</MypageMiniTitle>
      <MypageMiniTitle onClick={() => setSelectedMenu('myreservation')}>예약/취소 내역</MypageMiniTitle>
      <MypageBorder />
    ...
    <MyInfoContainer>
    <MyInfoTitle>&nbsp;<b>{member.name}</b>님 반갑습니다.</MyInfoTitle>
      <MyInfoBox>
        <MyInfoElement>
