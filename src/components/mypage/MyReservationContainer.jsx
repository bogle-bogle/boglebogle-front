...
import { MyInfoElement, MypageCard, MypageCardDescr, MypageCardElement, MypageCardImg, MypageCardTitle, MypageList, MypageSubtitle } from './mypage.style'
        ...
        {reservations.map(reservation => (
          <MypageCard key={reservation.id}>
            ...
            <MypageCardElement>
              ...
              <MypageCardDescr>예약 시간: {reservation.reservationTime}</MypageCardDescr>
            </MypageCardElement>
          </MypageCard>
        ))}
      </MypageList>
