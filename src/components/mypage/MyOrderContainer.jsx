...
import { MyInfoElement, MypageCard, MypageCardDescr, MypageCardElement, MypageCardImg, MypageCardTitle, MypageList, MypageListIndex, MypageSubtitle } from './mypage.style'
...
function MyOrderContainer() {
  ...
  return (
    <>
        ...
        <MypageList>
            <MypageListIndex>주문 번호 : #번  |  주문 일자 : 2023-07-08 </MypageListIndex>
            {orders.map(order => (
