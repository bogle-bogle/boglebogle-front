...
import suggestionScreenshot from "../../assets/main/suggestion-screen.gif"
    ...
    <div>
      <MainDescBox>
          ...
          <div className="content-box">
            <div className="heendy-box-container">
              <div className="heendy-box">
                <motion.div className="think-heendy-box"
                    initial={{ opacity: 1 }}
                    animate={{ opacity: 0 }}
                ...
                <motion.div className="good-heendy-box" 
                    initial={{ opacity: 0}}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 3.2, duration: 0.8 }}>
                  <LazyShow duration={0.7} delay={0.2}>
                    <div className="illust-box">
                      <motion.div className="illust-img illust-1"
                          transition={{
                            y: {
                              duration: 2.5,
                              repeat: Infinity,
                      ...
                      <motion.div className="illust-img illust-2"
                          transition={{
                            y: {
                              duration: 2.7,
                              repeat: Infinity,
                      ...
                      <motion.div className="illust-img illust-3"
                          transition={{
                            y: {
                              duration: 2.3,
                              repeat: Infinity,
                      ...
                      <motion.div className="illust-img illust-4"
                          transition={{
                            y: {
                              duration: 2.8,
                              repeat: Infinity,
            ...
            <div className="main-title-box">
              <LazyShow duration={0.9} delay={2.7}>
                <p className="title-1">
                  세상에 하나뿐인 나의 반려동물을 위한
                </p>
              </LazyShow>
              <LazyShow duration={0.9} delay={3}>
                <p className="title-2">
                  <span className="title-point-color-1">1대1 맞춤 추천</span> 서비스, <span className="title-point-color-2">더펫</span>
                </p>
              </LazyShow>
            </div>
          </div>
          <motion.div className="bg-box"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.7 }}
        ...
        <LazyShow duration={0.6} delay={3.3}>
          <motion.div className="more-icon-box"
            transition={{
              y: {
                duration: 1.2,
                repeat: Infinity,
      ...
      <FeatDescBox>
        <LazyShow duration={0.8} delay={0.6}>
          <FeatBox>
            ...
            <div className="w-text">
              <p>우리 반려동물의 <span className="text-bold">알러지 정보/연령대/견종</span>을 등록하면,</p>
              <p><span className="text-bold">꼭 맞는 상품들을 추천</span>해드려요!</p>
            </div>
          </FeatBox>
        </LazyShow>
        <LazyShow duration={0.8} delay={0.8}>
          <FeatBox>
            <div className="w-text">
              <p><span className="text-bold">입맛도 까다롭고, 알러지도 있는</span> 우리 반려동물,</p>
              <p>조금 더 <span className="text-bold">심층적인 추천</span>을 받고 싶다면?</p>
            </div>
            <div className="w-img">
              <img src={addpetScreenshot} className="img-shadow"/>
            </div>
        ...
        <LazyShow duration={0.8} delay={0.6}>
          <FeatBox>
            ...
            <div className="w-text">
              <p><span className="text-bold">매달 컨셉에 맞는 귀여운 장난감들과 생활용품</span>이 집앞까지!</p>
              <p>현대백화점 자체 편집숍 '위펫'에서 엄선한 상품들을 큐레이션하여 보내드려요</p>
            </div>
          </FeatBox>
        </LazyShow>
        <LazyShow duration={0.8} delay={0.8}>
          <FeatBox>
            <div className="w-text">
              <p>현대백화점, 현대아울렛의<span className="text-bold"> 흰디카</span></p>
