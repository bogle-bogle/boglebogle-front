    ...
    <div className="custom-page">
      ...
      <div className="upload-box">
        ...
        <div className="upload-section">
          ...
          <p className="box-title"><PiBoneLight /> 나의 반려동물</p>
          <hr className="divider" />
        ...
        <div className="upload-section">
          <hr className="divider" />
          <p className="box-title"><PiBoneLight /> 나의 반려동물이 잘 먹는 사료</p>
          <hr className="divider" />
          ...
          />
          <button className="feed-upload-button" onClick={handleUploadButtonClick}>
            사료 성분표 업로드
          </button>
        </div>
      </div>
      <p>성분 분석 완료!</p>
      <p>현대 더펫의 OCR 시스템과 AI 기반으로 분석한 결과, 가장 성분이 유사한 사료를 찾은 결과입니다.</p>
      <hr className="divider" />
