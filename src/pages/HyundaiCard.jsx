...
import { BackButton, CardCandidate, CardFront, CardInfoCol, CardInfoContainer, CardList, CardViewContainer, HyundaiCardContainer, SelectButton, SelectCardContainer } from '../components/hyundaicard/card.style'
      ...
      <SelectCardContainer>
          <CardViewContainer>
            ...
            <CardInfoCol>
                ...
                <BackButton><img src={rotateArrow} alt="" />뒷면보기</BackButton>
            </CardInfoCol>
          </CardViewContainer>
