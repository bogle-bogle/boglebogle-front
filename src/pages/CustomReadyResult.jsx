  ...
  return (
    <div className="custom-ready-page">
      ...
      <CustomGrid>
        ...
        <CustomDescr>
          현대 더펫의 OCR시스템과 AI 기반으로 분석한 결과, 가장 성분이 유사한
          사료를 찾은 결과입니다.
        </CustomDescr>
        <CustomTitle1>우리 '{selectedPet.name}'가 잘먹는 사료</CustomTitle1>
        <CustomTitle2>유사도 기반 추천 결과</CustomTitle2>
        <CustomPage>페이징이랑 개수 들어갈 자리</CustomPage>
        <CustomSidebar>
          {customData && customData.feedMainImgUrl && (
        ...
        <CustomProduct>
          상품 들어갈 자리 상품 들어갈 자리 상품 들어갈 자리 상품 들어갈 자리
          상품 들어갈 자리 상품 들어갈 자리 상품 들어갈 자리 상품 들어갈 자리
          상품 들어갈 자리
        </CustomProduct>
      </CustomGrid>
